...
- **Hub de la Enciclopedia:** Base de conocimiento con tres pestañas (Bestiario, Elenco, Museo), vista de detalle animada, navegación por sección, y formularios de creación/edición para monstruos, personajes y objetos — stats atómicos, subida de imágenes y rareza codificada por color en el museo.
...
| :------------------------- | :------------------------- | :------------------------------------------------------------------------------ | :----------------- |
| **Unitario e Integración** | Vitest 4 + Testing Library | Utils puras, Zustand store, componentes React (campañas, enciclopedia, formularios de creación de monstruos/personajes/objetos) — mocks globales centralizados en `vitest.setup.tsx` | `npm run test:run` |
