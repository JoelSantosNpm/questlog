...
export default function CampaignForm() {
  ...
  const { register, handleSubmit, trigger, getValues, formState: { errors } } = useForm<CampaignFormValues>({
    mode: "onChange",
  });
  ...
  return (
    <div className="w-full max-w-3xl mx-auto p-6 flex flex-col items-center">
      <form onSubmit={handleSubmit(onSubmit)} className="w-full relative min-h-[50vh] flex flex-col justify-center">
